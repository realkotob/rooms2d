...
class YoutubePlayer extends DOMElement {
  constructor(scene, x, y, width, height, config) {
    var scriptUrl = 'https:\/\/www.youtube.com\/s\/player\/5dd3f3b2\/www-widgetapi.vflset\/www-widgetapi.js'; if (!window["YT"]) var YT = { loading: 0, loaded: 0 }; if (!window["YTConfig"]) var YTConfig = { "host": "https://www.youtube.com" };
    if (!YT.loading) {
